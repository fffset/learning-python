...
def validate_isbn(isbn, length):
    ...
    # Karakter kontrolü (sadece 0-9 rakamları olmalı)
...
def main():
    ...
    isbn = values[0]  # burada hiç replace kullanma, test sistemi raw input istiyor
    try:
        length = int(values[1])
    except ValueError:
...
# main()  # Testler için yorum satırında